...
public class CarneBusq extends AppCompatActivity implements View.OnClickListener{
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        roja.setOnClickListener(view -> {
            Intent intencion = new Intent(getApplicationContext(), CarneRojaBusq.class);
            startActivity(intencion);
        });

        Button blanca = (Button) findViewById(R.id.button5);
        blanca.setOnClickListener(view -> {
            Intent intencion = new Intent(getApplicationContext(), CarneBlanBusq.class);
            startActivity(intencion);
        });
